...
public class Monster extends AbstractCharacter implements Movable, Enemy {
    ...
    public Monster(String name) {
        ...
        Animation animationmon = new Animation("resources/sprites/mother.png", 112, 162, 200);
        animationmon.setPingPong(true);
        setAnimation(animationmon);
    }
